...
public class ObjectiveSliderBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (triggerScript && triggerScript.flag)
        {
            ...
            CompleteObjective(currObjective);
        }
    ...
    public void CompleteObjective(int objectiveIndex)
    {
        ...
        objectiveStages[objectiveIndex].transform.GetChild(0).transform.GetChild(0).GetComponent<Image>().sprite = completeImage;
    ...
    void CheckForSecondObjective()
    {
        ...
        {
            if (FindObjectOfType<ChestTouch>().touchedChest)
            {
                CompleteObjective(currObjective);
            }
        }
